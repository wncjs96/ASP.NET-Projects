(function () {
    ...
    let mouse = {
        x: canvas.parentNode.clientWidth / 2,
        y: canvas.parentNode.clientHeight / 2
    }
    ...
    function Particle(x, y, radius, color) {
        ...
        this.update = function (particles) {
            ...
            if (this.x - this.radius <= 0 ||
                this.x + this.radius >= canvas.parentNode.clientWidth) {
                this.velocity.x = -this.velocity.x;
            }

            if (this.y - this.radius <= 0 ||
                this.y + this.radius >= canvas.parentNode.clientHeight) {
    ...
    function init() {
        ...
        for (let i = 0; i < 100; i++) {
            const radius = randomIntRange(2, 30);
